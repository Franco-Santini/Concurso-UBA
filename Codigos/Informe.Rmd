...
ventas_mensuales <- ds_final %>%
  ...
  collect() %>%
  arrange(category, month)   # 🔑 aseguramos orden temporal dentro de cada subgrupo
...
p <- ventas_mensuales %>%
  ...
  layout(
    title = "Evolución mensual de ventas - Top 10 subgrupos",
...
Luego de crear un modelo predictivo de la demanda, se deberán identificar los precios óptimos para cada producto que maximicen la ganancia. Esto implica encontrar el equilibrio adecuado entre el precio y la demanda para asegurar que la empresa obtenga el mayor rendimiento posible.
