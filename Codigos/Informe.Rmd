...
#### Modelos de “Gradient Boosting” + ARIMA para la determinación del precio semanal
...
Se puede observar que la combinación de hiperparámetros que tiene mayor $R^2$ promedio resulta de usar 165 árboles y 9 instancias mínimas.
El Score de las predicciones usando las 3 estrategias antes presentadas fueron:
