...
Durante el desarrollo del trabajo, nos encontramos con *limitaciones computacionales* al entrenar modelos de predicción y optimización de precios, debido a que los equipos disponibles no contaban con capacidad de procesamiento elevada. Esto implicó que ciertas exploraciones de parámetros y pruebas de modelos más complejos fueran más lentas o directamente inviables. De contar con recursos en la **nube**, sería posible ampliar significativamente el horizonte de experimentación, permitiendo probar más combinaciones de parámetros, generar mayor cantidad de pronósticos y, en última instancia, mejorar la calidad y robustez de las soluciones propuestas.
